...
The label can wrap to two lines before truncating. The trailing value truncates after one line. When both sides have long content, the trailing gets layout priority by default (see [Priority](#priority) to invert this).
