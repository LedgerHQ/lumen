...
- Use `DialogBodyStickyContent` for search or filter controls that must stay visible while the list scrolls
...
<Dialog>
  ...
  <DialogContent className='w-[800px]'>
    <DialogHeader appearance='extended' title='Extended Dialog' />
    <DialogBody>Extended content here</DialogBody>
  </DialogContent>
</Dialog>
```
