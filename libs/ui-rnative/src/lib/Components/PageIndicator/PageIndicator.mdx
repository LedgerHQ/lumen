...
The PageIndicator uses React Native Reanimated for smooth animations. Animations run on the UI thread for optimal performance, even with frequent page changes.
