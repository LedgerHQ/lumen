...
```
  ...
  <DontBlockItem
    title="Don't add children when using render"
    description='When render is provided, children are ignored — the render function controls the trigger UI entirely. Note: label is still used as the bottom sheet header title.'
  >
