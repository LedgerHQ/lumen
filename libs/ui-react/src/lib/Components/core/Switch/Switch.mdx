...
`@radix-ui/react-switch` ships with `@ledgerhq/lumen-ui-react` and provides accessible switch functionality with proper keyboard navigation, focus management, and screen reader support.
