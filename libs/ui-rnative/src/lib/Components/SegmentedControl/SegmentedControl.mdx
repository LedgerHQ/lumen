...
- **`fixed`** (default): all segments share equal width, filling the container. Best suited for mobile where full-width controls feel native.
- **`hug`**: each segment sizes to its content.
