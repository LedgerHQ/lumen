...
For toggleable options that should read as an on/off action rather than a checkbox:

<Canvas of={MenuStories.WithSwitchItems} />
...
<Source of={MenuStories.WithSwitchItems} />
