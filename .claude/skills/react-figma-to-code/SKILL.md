...
1. **Use the closest available token** (e.g., 112px instead of 108px, 96px instead of 90px)
2. **Document the deviation** in code comments
3. **Consider requesting the token be added** to Figma if it's frequently needed

```tsx
// ✅ Do - Use closest token and document
<Tile
  className='w-112' // Using 112px (closest to Figma's 108px)
  size='md'
/>
```
