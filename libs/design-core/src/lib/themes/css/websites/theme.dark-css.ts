...
export const tokens = {
  '.dark': {
    ...
    '--color-background-avatar-blue': 'var(--color-dark-avatar-blue)',
    '--color-background-avatar-pink': 'var(--color-dark-avatar-pink)',
    '--color-background-avatar-turquoise': 'var(--color-dark-avatar-turquoise)',
    '--color-background-avatar-yellow': 'var(--color-dark-avatar-yellow)',
    '--color-background-avatar-orange': 'var(--color-dark-avatar-orange)',
    '--color-background-avatar-red': 'var(--color-dark-avatar-red)',
    '--color-background-avatar-green': 'var(--color-dark-avatar-green)',
    '--color-background-avatar-purple': 'var(--color-dark-avatar-purple)',
