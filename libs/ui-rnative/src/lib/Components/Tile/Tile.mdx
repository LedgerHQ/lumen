...
- **Tile**: Root container; direct children are TileLeading and optionally TileTrailing, laid out vertically
...
import { Tile, TileLeading, TileContent, TileTitle, TileDescription, Spot } from '@ledgerhq/lumen-ui-rnative';
