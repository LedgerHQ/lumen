...
`@base-ui/react` ships with `@ledgerhq/lumen-ui-react` and provides accessible menu behavior with proper keyboard navigation, focus management, and screen reader support.
