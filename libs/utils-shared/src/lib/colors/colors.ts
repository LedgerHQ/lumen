 ...
 *
 * @internal Use the platform-specific resolver instead: `resolveAvatarColor`
 * from `ui-react`, or `useResolveAvatarColor` from `ui-rnative`. They map the
 * key to the correct color value.
 */
