...
- **SwitchItem**: Items with switch selection
...
Checkbox items toggle options, switch items read as an on/off action rather
than a checkbox, and radio items pick a single value from multiple options:

<Canvas of={MenuStories.ItemTypeShowcase} />
...
<Source of={MenuStories.ItemTypeShowcase} />
