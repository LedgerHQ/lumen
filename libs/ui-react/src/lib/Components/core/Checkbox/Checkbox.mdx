...
`@radix-ui/react-checkbox` ships with `@ledgerhq/lumen-ui-react` and provides accessible checkbox functionality with proper keyboard navigation, focus management, and screen reader support.
