...
dot, wrap the `Avatar` in a `DotIndicator` and derive the dot size from the avatar
size with the new `getDotSize` helper.
...
// after
import { Avatar, DotIndicator, getDotSize } from '@ledgerhq/lumen-ui-react';
