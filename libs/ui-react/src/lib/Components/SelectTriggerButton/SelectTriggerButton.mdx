...
import * as SelectTriggerButtonStories from './SelectTriggerButton.stories';

<Meta title='Components/SelectTriggerButton' of={SelectTriggerButtonStories} />
...
<Canvas of={SelectTriggerButtonStories.Base} />
<Controls of={SelectTriggerButtonStories.Base} />

## Appearance

Three appearances are available: `gray` (default), `transparent`, and `no-background`.

<Canvas of={SelectTriggerButtonStories.AllAppearancesWithIcons} />

## Sizes

<Canvas of={SelectTriggerButtonStories.SizeShowcase} />
...
<Canvas of={SelectTriggerButtonStories.IconTypeShowcase} />
