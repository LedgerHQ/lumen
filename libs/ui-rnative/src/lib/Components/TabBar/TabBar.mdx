...
- **Tab Items**: Individual interactive elements representing different views. A minimum of **2 tab items is required** — using fewer will result in a TypeScript error.
