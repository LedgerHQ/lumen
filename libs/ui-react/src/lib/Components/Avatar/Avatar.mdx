...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      title='Use the size prop'
      description='Use the size prop to control avatar dimensions for consistent sizing'
    >
...
```
    ...
    <DontBlockItem
      title="Don't override size with className"
      description='Avoid using className to change component dimensions'
    >
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      title='Use showNotification prop'
      description='Use the showNotification prop to display notification indicators'
    >
...
```
    ...
    <DontBlockItem
      title="Don't add custom notification elements"
      description='Avoid manually adding notification indicators outside the component'
    >
