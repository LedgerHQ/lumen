...
- **Labels**: Text descriptions for each tab
...
When icons are not provided, the component gracefully falls back to placeholder icons. If a label isn't provided, the icon is vertically centered.
