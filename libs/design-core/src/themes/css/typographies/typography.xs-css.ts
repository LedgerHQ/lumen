...
export const tokens: Record<string, Record<string, string | number>> = {
  '@media (min-width: 360px)': {
    ...
    '--font-style-responsive-display-2-size': 'var(--font-size-40)',
    ...
    '--font-style-heading-3-size-2': 'var(--font-size-24)',
    ...
    '--font-style-grid-column-count': '4px',
