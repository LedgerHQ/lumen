...
npm install tailwindcss@^4.1.17 react@^19.0.0 clsx tailwind-merge class-variance-authority
```
...
And import our stylesheet next to Tailwind in your main CSS file, so the
utilities compiled into our components are emitted:
