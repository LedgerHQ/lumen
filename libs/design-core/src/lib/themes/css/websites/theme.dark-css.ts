...
export const tokens = {
  '.dark': {
    ...
    '--color-background-active-subtle-website-pressed':
      'var(--color-dark-purple-200)',
    '--color-background-error-transparent': 'var(--color-dark-red-600-15)',
