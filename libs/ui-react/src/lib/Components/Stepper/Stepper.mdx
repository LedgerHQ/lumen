...
<Meta title='Feedback/Stepper/Docs' of={StepperStories} />
...
### Default
The default state with an interactive accent color for the progress arc. Use this for current, ongoing processes.

### Disabled
A muted appearance for the progress arc. Use this for paused or disabled steppers.
