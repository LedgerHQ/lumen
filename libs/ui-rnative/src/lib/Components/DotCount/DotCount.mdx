...
<CustomTabs>
  <Tab label="Overview">
    ...
    DotCount displays a numeric count inside a colored pill. It supports two sizes (`md` and `sm`), two appearances (`base` and `red`), and can be pinned to the top-right of a child element.
